...
BLOCK_PROCESS_FUNC(GlassWhite)
BLOCK_PROCESS_FUNC(GlassGrey)
BLOCK_PROCESS_FUNC(GlassRed)
BLOCK_PROCESS_FUNC(GlassYellow)
BLOCK_PROCESS_FUNC(GlassGreen)
BLOCK_PROCESS_FUNC(GlassCian)
