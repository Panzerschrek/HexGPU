...
SystemWindow::SystemWindow(Settings& settings)
{
	...
	const bool fullscreen= settings.GetOrSetInt("r_fullscreeen", 0) != 0;

	const Uint32 window_flags= SDL_WINDOW_SHOWN | SDL_WINDOW_VULKAN | (fullscreen ? SDL_WINDOW_FULLSCREEN : 0);
